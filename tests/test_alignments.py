...
@pytest.mark.parametrize(
    ...
    [
        ...
        ([("chr1", 0, 10, 0)], [("chr2", 0, 10, 0)], []),
        ([("chr1", 0, 10, 0)], [("chr1", 10, 11, 0)], []),
        ([("chr1", 0, 10, 0)], [("chr1", 9, 10, 0)], [(0, 0, 1)]),
        ([("chr1", 0, 10, 0)], [("chr1", 0, 1, 0)], [(0, 0, 1)]),
        ([("chr1", 0, 10, 0)], [("chr1", 0, 1, 0), ("chr1", 5, 10, 1)], [(0, 0, 1), (0, 1, 5)]),
        ([("chr1", 0, 1, 0), ("chr1", 5, 10, 1)], [("chr1", 0, 10, 0)], [(0, 0, 1), (1, 0, 5)]),
    ],
)
