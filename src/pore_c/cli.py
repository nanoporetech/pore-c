...
def comparison_contact_map(matrix1_file_in,matrix2_file_in, ref_bin_file, graph_file_out, matrix_type, normalise,chr_file):
    if chr_file == "None":
        comparison_contact_map_tool(matrix1_file_in, matrix2_file_in, ref_bin_file, graph_file_out, matrix_type, normalise)
    else:
        comparison_contact_map_tool(matrix1_file_in, matrix2_file_in, ref_bin_file, graph_file_out, matrix_type, normalise,chr_file)
