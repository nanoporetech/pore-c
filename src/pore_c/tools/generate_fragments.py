...
def create_bin_file(reference_fai: str, bedfile_out: str,  bin_size: int) -> None:
    ...
    for line in open(reference_fai):
        ...
        frags = list(zip(frags[:-1],frags[1:])) #in the case where a ref seq is shorter than bin, this line elims any entries, allowing the whole seq to be added as the tail frag
