...
def cluster_reads(input_bam: str, keep_bam: str, discard_bam: str, trim: int, mapping_quality_cutoff: int, statsfile: Optional[str] = None) -> Tuple[int, int, int, int]:
    ...
    if statsfile != None:
        stats_out = open(statsfile,'w')
        stats_out.write('read_id,mapping_id,filter_retained,query_start,query_end,mapq\n')
    num_reads = 0
    num_reads_kept = 0
    num_aligns = 0
    num_aligns_kept = 0
